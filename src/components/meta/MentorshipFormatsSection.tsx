...
type ModalKind = "subscription" | "workshop";
        ...
        <div className="mx-auto max-w-[1280px] px-6 py-16 md:px-12 md:py-24 lg:px-[96px] lg:py-[120px]">
          ...
          <div className="mt-10 flex flex-wrap items-start justify-center gap-8 md:gap-10">
            ...
            <ManifestOfferCard
              ...
              onMore={() => setActiveModal("workshop")}
              actionLabel="more"
            />
          </div>
        </div>
      ...
      {activeModal ? (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-label={activeModal === "subscription" ? "Запись на первую встречу" : "Дополнительные воркшопы"}
            ...
            {activeModal === "subscription" ? (
              <>
                ...
                <a
                  ...
                  className={`mx-auto mt-8 flex h-11 min-w-[260px] items-center justify-center bg-black px-7 text-[10px] font-medium uppercase tracking-[0.2em] text-white transition-colors hover:bg-zinc-900 ${interSansClassName}`}
                >
              ...
              <>
                <p className={`text-[18px] leading-[1.6] text-zinc-800 ${interSansClassName}`}>
                  Воркшопы — это практические сессии, на которых мы работаем над прикладной задачей.
                </p>
                <a
                  href={TELEGRAM_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`mx-auto mt-8 flex h-11 min-w-[200px] items-center justify-center bg-black px-7 text-[10px] font-medium uppercase tracking-[0.2em] text-white transition-colors hover:bg-zinc-900 ${interSansClassName}`}
                >
                  Записаться
                </a>
              </>

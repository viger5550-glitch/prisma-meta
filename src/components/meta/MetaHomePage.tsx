import { HomeAuthorSection } from "@/components/meta/HomeAuthorSection";
import { HomeCatalogSection } from "@/components/meta/HomeCatalogSection";
import { homeShell } from "@/components/meta/homeShell";
...
/** Главная: hero |PRISMA, каталог офферов, блок об авторе. */
  ...
  return (
    <div className="min-h-screen bg-white text-black antialiased">
      ...
      <section className="bg-white">
        <div className={`${homeShell} pb-14 pt-12 md:pb-20 md:pt-16 lg:pb-24 lg:pt-[120px]`}>
          <div className="grid max-w-[995px] grid-cols-[auto_minmax(0,1fr)] gap-x-0 gap-y-8">
            ...
            >
              Лаборатория по созданию своих авторских продуктов
            </p>
          </div>
        </div>
      </section>

...
const CHALLENGE_HEX_CARDS: ChallengeOfferCard[] = [
  {
    ...
    detail: {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "А ещё у нас есть милый бот от Content Hero, который помогает не слиться:",
        },
        {
          type: "list",
          items: [
    ...
    detail: {
      ...
      blocks: [
        ...
        },
        {
          type: "list",
          items: [
            "как смотреть на свой продукт через задачи других",
            "как получать взгляд со стороны, когда застрял",
            "как находить решения быстрее за счёт коллективного мышления",
          ],
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "list",
          items: [
            "другие авторы, эксперты в своей области делятся знаниями и инструментами, а мы сразу внедряем",
          ],
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "list",
          items: [
            "раз в неделю мы бываем друг у друга, чтобы неформально пообщаться и переопылиться",
          ],
        },
      ],
    },
      ...
      <div className="min-h-screen bg-white text-black antialiased">
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-[1280px] px-6 pb-14 pt-12 md:px-12 md:pb-20 md:pt-16 lg:px-[96px] lg:pb-24 lg:pt-[110px]">
            <p className={`text-[10px] uppercase tracking-[0.4em] text-black/50 ${interSans}`}>CHALLENGE</p>

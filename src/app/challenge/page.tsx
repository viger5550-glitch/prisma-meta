  ...
  },
  {
    ...
    detail: {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "Диана поможет нам разбираться:",
        },
        {
          type: "list",
          items: [
            "как считать юнит-экономику авторских продуктов",
            "какие есть модели монетизации и какие подойдут именно вашему продукту",
            "построим дашборд метрик, на основе которых будем принимать продуктовые решения",
          ],
        },
        {
          type: "paragraph",
...
const AUTHORS_DETAIL = {
  ...
  title: "Кто такие продуктоделы",
  blocks: [
    {
      type: "paragraph" as const,
      text:
        "Продуктоделы — это продуктовые авторы, которые создают продукты не по шаблону, а из своего опыта, мышления и интереса.",
    },
    {
      type: "paragraph" as const,
      text:
...
export const metadata: Metadata = {
  title: "Продуктоделы — challenge | PRISMA",
  description:
    ...
    <ManifestFontVars>
      <div className="min-h-screen bg-white text-black antialiased">
          ...
          <div className="mx-auto max-w-[1280px] px-6 pb-14 pt-12 md:px-12 md:pb-20 md:pt-16 lg:px-[96px] lg:pb-24 lg:pt-[110px]">
            ...
            >
              ...
              <span
                ...
                style={{ color: "rgba(95, 94, 94, 0.6)" }}
              >
                Автор и ведущая Виктория Герман
              </span>
            </Link>
          </div>
        </section>
        ...
        <ChallengeOffersSection
          ...
          centerLabel="Кто такие продуктоделы?"
          centerHref="/about"

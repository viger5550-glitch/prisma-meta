          ...
          <div className="mx-auto max-w-[1280px] px-6 pb-14 pt-2 md:px-12 md:pb-20 md:pt-4 lg:px-[96px] lg:pb-24 lg:pt-6">
            ...
            >
              ...
              <p className="mt-4">
                ...
                возможные грабли соло-фаундерства. И с этим опытом я готова помогать помогу вам пройти этот путь без
                лишних &quot;граблей&quot;. Я буду вашим внешним фактором и партнёром по движению.
              </p>
